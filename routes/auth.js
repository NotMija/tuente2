...
router.get('/auth/profileForm', (req, res) => {
  res.render('auth/profileForm', { error: req.flash("error") });
});

router.get('/auth/editProfile', (req, res) => {
  res.render('auth/editProfile', { error: req.flash("error") });
});
